#!/usr/bin/env python3
"""
Recuperation des codes promo PrettyLittleThing depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/prettylittlething.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/prettylittlething.fr"
STORE_NAME = "PrettyLittleThing"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour PrettyLittleThing depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-prettylittlething)"
    }
    try:
